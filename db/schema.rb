...
ActiveRecord::Schema.define(version: 2022_11_05_050105) do
  ...
  create_table "shipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
